...
class FeatureController extends Controller
{
    ...
    {  
        ...
        //     }])
        //     -> withExists([
        //         'upvotes as user has upvoted' => function($query) use($currentUserId){
        //             $query->where('user_id',$currentUserId)
        //                 ->where('upvote',1);

        //         },
        //         'upvotes as user has downvoted' => function($query)use($currentUserId) {
    ...
    public function store(Request $request)
    {
        ...
        return to_route('feature.index')->with('success','feature created sucessfully');
    ...
    public function update(Request $request, Feature $feature)
    {
        ...
        return to_route('feature.index')->with('success','Feature updated sucessfully');
    }
